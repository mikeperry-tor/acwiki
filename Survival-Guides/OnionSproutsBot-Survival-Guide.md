...
7. Install it `python setup.py install` so it will generate the locales and place them in the right place
8. Restart onionsprouts bot `systemctl --user restart onionsproutsbot`
